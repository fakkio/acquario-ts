...
In v0.1 there are no organelles, so the doc's composition-derived colour scheme ("green for chloroplasts, red for muscle") encodes nothing, and the screen would show a few hundred identical grey dots. The genuinely interesting quantity — which _lineages_ are winning — would be invisible.
